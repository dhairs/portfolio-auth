          ...
          {checkingSession ? (
            ...
            >
              <p className="text-sm text-gray-400 leading-relaxed font-light mb-8">
                Sign in using your Google account to access private resources and manage your session across all subdomains.
              </p>
              ...
              >
                ...
                {authenticating ? "Authenticating session..." : "Continue with Google"}
              </button>
            </motion.div>
          )}
        </AnimatePresence>
